...
namespace backend_API.Dto
{
   public class InstalacionDto : DtoBase
   {
      ...
      {
         get { return GetDefinicion(Estructura); }
         set { }
      }
      ...
      {
         if (Estructura.Equals("Coplanar"))
            return "La estructura COPLANAR, teniendo en cuenta la integración urbanística" +
         ...
         else return "La estructura TRIANGULAR, teniendo en cuenta la optimización de la" +
